...
function! s:HLUDSync(tagsfile, udtagfile)
	...
	call system('~/.vim/djtags ' . a:tagsfile . " " . a:udtagfile)
	return
...
" ProjectCreatedj                 {{{1
" create project djdata
function! s:ProjectCreatedj()
    " create project data directory.
    if !isdirectory(g:project_data)
        call mkdir(g:project_data, "p")
    endif
...
command! -nargs=0 -bar ProjectCreate call s:ProjectCreate()
command! -nargs=0 -bar ProjectCreatedj call s:ProjectCreatedj()
command! -nargs=0 -bar ProjectUpdate call s:ProjectUpdate()
command! -nargs=0 -bar ProjectLoad call s:ProjectLoad()
command! -nargs=0 -bar ProjectQuit call s:ProjectQuit()
...
nnoremap <leader>jd :ProjectCreatedj<cr>
